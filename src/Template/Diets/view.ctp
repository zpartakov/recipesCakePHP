...
<div class="diets view large-10 medium-9 columns">
    <h2><?= h($diet->id) ?></h2>
    <div class="row">
        ...
        <div class="large-2 columns numbers end">
            ...
            <p><?= $this->Number->format($diet->id) ?></p>
        </div>
        <div class="large-2 columns dates end">
            <h6 class="subheader"><?= __('Date Mod') ?></h6>
            <p><?= h($diet->date_mod) ?></p>
        </div>
    </div>
    <div class="row texts">
        <div class="columns large-9">
            ...
            <?= $this->Text->autoParagraph(h($diet->rem)) ?>
        </div>
    </div>
</div>
<div class="related row">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($diet->recettes as $recettes): ?>
        <tr>
            <td><?= h($recettes->id) ?></td>
...
<div class="related row">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($diet->recettes00 as $recettes00): ?>
        <tr>
