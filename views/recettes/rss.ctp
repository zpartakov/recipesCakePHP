...
function sortieRSS($id, $titre, $date, $provenance)
	{
		...
		echo "
	   <item>
	    <title>xxx" .$titre ." (" .$provenance .")</title>
	    <link>http://radeff.net/recettes2/view/" .$id ."</link>
 ...
 */
	...
	echo '<?xml-stylesheet title="XSL formatting" type="text/xsl" href="http://radeff.net/recettes2/recettes/rss" ?><rss version="2.0"
...
?>
  ...
  <link>http://radeff.net/recettes2/</link>
  <atom:link href="http://radeff.net/recettes2/recettes/rss" rel="self" type="application/rss+xml"/>
